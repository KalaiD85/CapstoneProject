...
# --- SUMMARY --- #
Part1 - Data Acquisition, Cleaning, and Exploratory Analysis which generates the cleaned_data.csv

Part2 - Supervised Machine Learning Model — Build, Train, and Evaluate

Part3 - Advanced Modeling — Ensembles, Tuning, and Full ML Pipeline which geneerates the best model file (best_model.pkl)

Part4 - Demonstrates a production-ready pipeline where ML predictions are explained by an LLM 